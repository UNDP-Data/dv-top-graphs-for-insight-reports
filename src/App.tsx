...
function App() {
  ...
  const AverageFiscalData = [
    {
      iso: 'LIDC',
      'Resource revenue (% of revenue)': 16.5,
      'Revenue (% of GDP)': 21.8,
      'Government debt (% of GDP)': 59.1,
      'Natural resources rents (% of GDP)': 10.15,
      'Total external debt servicing (% of revenue)': 15.33,
      'Credit rating': 5.9,
      '10-year bond yield (%)': 17.69,
      'DSA Rating': 2.5,
    },
    {
      iso: 'EMMIE',
      'Resource revenue (% of revenue)': 17.6,
      'Revenue (% of GDP)': 31.02,
      'Government debt (% of GDP)': 60.1,
      'Natural resources rents (% of GDP)': 7.92,
      'Total external debt servicing (% of revenue)': 12.36,
      'Credit rating': 8.06,
      '10-year bond yield (%)': 8.72187,
      'DSA Rating': 2.83,
    },
    {
      iso: 'Advanced Economy',
      'Resource revenue (% of revenue)': 0.44,
      'Revenue (% of GDP)': 39.3,
      'Government debt (% of GDP)': 68.55,
      'Natural resources rents (% of GDP)': 1,
      'Total external debt servicing (% of revenue)': 5.38,
      'Credit rating': null,
      '10-year bond yield (%)': 3.2,
      'DSA Rating': null,
    },
  ];
          ...
          <div className='flex-div flex-space-between margin-top-05'>
            ...
            >
              ...
              >
                ...
                (April 2025), and on CO2 emissions from the Global Carbon Budget
                 2024 and EDGAR (JRC and IEA).
              </div>
            </div>
          </div>
        </div>
